...
//###############################################################
//###################Aqui deben ir los atributos y sus categorías
//###############################################################
//###############################################################

$featurearray = array("Información de prensa" => array("La prensa destaca su alta productividad científica","La prensa indica que su productividad científica esta en el promedio nacional","La prensa no ofrece noticias sobre esta universidad"), "Información corporativa" => array("Su pagina web indica que su nivel académico es alto","Su pagina web indica que su nivel académico esta en el promedio nacional","Su pagina web no presenta información corporativa"), "Twit de uno de tus contactos de redes sociales:" => array("Felicita la acreditación de 7 años obtenida por la universidad","Comparte artículo sobre universidades acreditadas por 5 años que incluye a ésta","Comenta que esta universidad tiene acreditación de 3 años"), "Twit de reconocido influencer" => array("Relata que la calidad académica de esta Universidad es buena","Relata que la calidad académica de esta universidad es regular","Relata una mala experiencia académica con esta universidad"));
